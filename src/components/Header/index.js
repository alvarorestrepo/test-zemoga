import papa from "../../assets/img/pope-francis.@2x.png";
import like from "../../assets/img/thumbs-up.svg";
...
function Header() {
  return (
    <header className="hero">
      <img className="hero__background" src={papa} alt="Pope Francis" />
          ...
          <div className="featured-card__content">
            ...
            <div className="featured-card__buttons">
              ...
              <button className="icon-button" aria-label="thumbs down">
                <img src={dislike} alt="thumbs down" />
              </button>
            </div>
          </div>
        </div>
